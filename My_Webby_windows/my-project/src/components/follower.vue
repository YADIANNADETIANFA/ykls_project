...
export default {
  ...
  mounted() {
    if(this.info.followed){
      ...
      this.followUserButton = 'display: none; margin-left: 20px;';
      this.unFollowUserButton = 'display: inline; margin-left: 20px;';
    }else{
      //当前登录用户，未关注该粉丝
      this.followButtonText = '关注他（她）';
      this.followUserButton = 'display: inline; margin-left: 20px;';
      this.unFollowUserButton = 'display: none; margin-left: 20px;';
    }
  }
}
</script>
